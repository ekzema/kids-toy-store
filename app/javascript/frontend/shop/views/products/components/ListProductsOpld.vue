                    ...
                    <div class="product">
                      <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/1.png" alt="Image">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/2.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/3.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/4.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/5.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/6.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/7.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          ...
                          <div class="product-item">
                            <div class="product-thumb">
                              <img src="/img/shop/8.png" alt="Image">
                              <div class="product-action">
                                <a class="action-quick-view" href="shop-cart.html"><i class="ion-ios-cart"></i></a>
                                <a class="action-quick-view" href="javascript:void(0)"><i class="ion-arrow-expand"></i></a>
                                <a class="action-quick-view" href="shop-wishlist.html"><i class="ion-heart"></i></a>
      ...
      <div class="product-quick-view-content">
        ...
        <div class="row row-gutter-0">
          <div class="col-lg-6 col-md-6 col-12">
            <div class="thumb">
              <img src="/img/shop/quick-view1.jpg" alt="Image">
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-12">
